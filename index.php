    ...
    <section>
        <div class="content">
            <div class="main-content">
                ...
                <span data-aos="fade-left" data-aos-duration="1500" data-aos-delay="200">
                    <?php echo $name; ?>
                </span>
                <p data-aos="flip-up" data-aos-duration="1500" data-aos-delay="400">
                    I am 3rd year student from <?php echo $school; ?> and my degree is <?php echo $degree; ?>.
                    I love coding and this is my simple task of our school.
                </p>
                <div class="buttons">
            ...
            <div class="image">
                <img src="minicc.jpg" data-aos="zoom-out" data-aos-duration="2000">
            </div>
        </div>
    </section>
    <footer style="text-align:center; margin-top:20px;">
        &copy; <?php echo $year; ?> <?php echo $name; ?>. All rights reserved.
    </footer>
